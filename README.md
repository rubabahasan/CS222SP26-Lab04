...
6. [Hints](#how-to-generate-class-members-in-your-ide) Open `Book.java`. Fields have been provided to you, but no methods. Write getter & setter methods, or have your IDE generate them for you. Note that the setter methods for publishDate variable should have the signature: void setPublishDate(String publishDate).
...
[Go back to Book instructions](#middle-book-java)
...
[Go back to the Library instructions](#end-library-java)
